...
After the Feature Selection the Recall is reduced from 0.586 to 0.546, instead the Precision is increased from 0.454 to 0.502; overall the F$_1$-measure is increased from 0.512 to 0.523 with the matrix A. 
